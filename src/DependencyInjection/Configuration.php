        ...
        $rootNode
            ...
            ->children()
                ...
                ->arrayNode('instances')
                    ...
                    ->prototype('array')
                        ->children()
                            ->enumNode('driver')->values(array('local', 's3'))->defaultValue('local')->end()
                            ->arrayNode('s3_settings')
                                ...
                                ->children()
                                    ...
                                    ->booleanNode('allow_bulk')->defaultTrue()->end()
                                    ->booleanNode('thumbnail_use_local_storage')->defaultFalse()->end()
                                    ->scalarNode('encryption')->defaultNull()->end()
                                    ->enumNode('acl_policy')
                                        ->values(array('ACL_POLICY_DEFAULT', 'ACL_POLICY_INHERIT'))
                                        ->defaultValue('ACL_POLICY_DEFAULT')
                                    ->end()
                                    ->enumNode('default_acl')
                                        ->values(array('ACL_PRIVATE', 'ACL_PUBLIC_READ', 'ACL_PUBLIC_READ_WRITE', 'ACL_AUTHENTICATED_READ', 'ACL_BUCKET_OWNER_READ', 'ACL_BUCKET_OWNER_FULL_CONTROL'))
                                        ->defaultValue('local')
                                    ->end()
                                ->end()
                            ->end()
